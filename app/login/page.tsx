    ...
    <div className='p-4 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex items-center justify-center'>
        ...
        <div className='h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] md:w-full lg:w-[60%] 2xl:w-1/2'>
          ...
          <div className='p-10 flex flex-col gap-8 md:w-1/2'>
              ...
              <button className='flex gap-4 ring-1 ring-orange-100 rounded-md p-4' onClick={()=>signIn("google")}>
                <Image src="/google.png" alt='' width={20} height={20} className='object-contain'/>
                <span>Sign in with Google</span>
              </button>
              <button className='flex gap-4 ring-1 ring-blue-100 rounded-md p-4' onClick={()=>signIn("github")}>
